...
/* Recurso. No hay buffer solo se puede escribir en o leer de una variable.
Una mejora interesante sería hacer un buffer donde pudieran escribir y leer los escritores y
lectores sin causar incoherencia en los datos*/
